...
При реализации методов был выбран подход с модификацией внутреннего состояния объекта (self.df) для оптимизации использования оперативной памяти и минимизации лишнего копирования данных. В секции "Пути развития" указана возможность перехода к иммутабельной логике для сценариев, где важна сохранность промежуточных состояний.
...
> Данные до обработки:
  <img width="800" height="600" alt="данные до обработки" src="img/img_1.png" />
...
>  Этапы:
  <img width="800" height="600" alt="2026-02-10_20-23-08" src="img/img_3.png" />

В результате данные готовы для работы, все значения числовые а дипазоне от 0 до 1 и не имеют пропусков.

>  Min-Max:
  <img width="800" height="600" alt="2026-02-10_20-23-28" src="img/img_4.png" />
...
### Возможные пути развития
 1.  Доработка метода transform;
 2.  Некоторые улучшения обработки различных ситуаций и способов использования для исключения проблем с возможными мутациями датасета;
 3.  Интеграция с polars для ускорения обработкина больших данных;
 4. Добавление метода для автоматической обработки выбросов;
 5. Поддержка разреженных матриц для оптимизации памяти при One-Hot кодировании.
